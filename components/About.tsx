...
export default function About({}: Props) {
  return (
    <motion.div
      ...
      className='flex flex-col relative text-center md:text-left md:flex-row max-w-7xl px-5 md:px-10 justify-evenly mx-auto items-center'
      style={{ minHeight: '100vh' }}
    >
      <h3 className='sm:top-24 top-24 xl:top-40 xl:pl-16 absolute uppercase tracking-[20px] text-cyan-500 text-2xl md:static md:ml-5'>
        About
      </h3>
      <motion.img
      ...
      />
      <div className='space-y-10 px-0 md:px-10 lg:pl-12'>
